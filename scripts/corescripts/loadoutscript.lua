...
--waitForChild(game:GetService("CoreGui"):FindFirstChild("RobloxGui"),"CurrentLoadout")
local currentLoadout = game:GetService("CoreGui"):FindFirstChild("RobloxGui").CurrentLoadout
