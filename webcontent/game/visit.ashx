--rbxsig%Dimowunv7UmEaxSA/g/qJLvQ3XmweKbanyTFNZYxALX5MxU6ogdLlBT4w77D+nxhnmeN82clVtkV+dS67rri71V0RjwuIoR8xE5oEUqyMoVd8OhVvgZ6A94N6GGGBVcflVldoDiR+X+CifnCxiWk6phtXYmmBN/0tp7YK/6a8Fo=%-- Prepended to Edit.lua and Visit.lua and Studio.lua and PlaySolo.lua--
...
if success then
	...
	if false then
		game:HttpPost("http://localhost/Error/Lua.ashx?", "Visit.lua: " .. err)
	end
end
